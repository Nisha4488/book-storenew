1)yarn add bootswatch &import  'bootstrap/dist/lux/bootstrap.min.css';
2)used fluid class with container to get rid of padding
3)how to look for react in developer tool:install react extension
